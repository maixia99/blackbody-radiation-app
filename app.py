...
target_lam = st.sidebar.number_input("关注点波长 (μm)", min_value=0.1, max_value=40.0, value=10.0, step=0.1)

st.sidebar.subheader("2. 自定义波段能量分析")
band_start = st.sidebar.number_input("波段起始波长 (μm)", min_value=0.1, max_value=40.0, value=8.0, step=0.1)
band_end = st.sidebar.number_input("波段结束波长 (μm)", min_value=band_start, max_value=40.0, value=13.0, step=0.1)
